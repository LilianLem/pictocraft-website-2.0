...
final class Version20230313162657 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE shop_payment_status (id INT UNSIGNED AUTO_INCREMENT NOT NULL, payment_id INT UNSIGNED NOT NULL, status ENUM(\'En attente de paiement\', \'Validé\', \'Échoué\', \'Annulé\', \'Remboursé totalement (sur moyen de paiement)\', \'Remboursé partiellement (sur moyen de paiement)\', \'Remboursé totalement (sur porte-monnaie)\') NOT NULL COMMENT \'(DC2Enum:a91fa3baa0c61135c8dfe37e72757a19)(DC2Type:payment_status_enum)\', date DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', comment VARCHAR(255) DEFAULT NULL, INDEX IDX_CE99FF8C4C3A3BB (payment_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
